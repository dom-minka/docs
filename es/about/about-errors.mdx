...
Los sistemas externos como DICE y MOL utilizan códigos de error específicos, sin embargo, Transfiya cuenta con un mecanismo que mapea automáticamente estos códigos a su estructura de errores HTTP.
