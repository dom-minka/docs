...
Para la creación de código QR el usuario podrá realizarlo a través de la zona Bre-B, el cual es obligatorio dentro de lo propuesto por la regulación, también cada entidad podra utilizar cualquier otro punto relacionado a la experiencia QR como punto de ingreso para sus usuarios
