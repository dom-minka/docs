...
2. **Lectura de QR:** Una vez realizo el escaneo, la Entidad participante deberá envíar el contenido de la cadena TLV a través del servicio expuesto por Transfiya. El detalle de este proceso podrá ser consultado en el apartado [Cómo leer un QR - Transfiya Guide](https://transfiya.me/1-85/directorio-federado/tecnologia-de-acceso-qr/como-leer-un-qr).
       ...
       "26": {
           ...
           "data": {
               ...
               "02": {
                   ...
                   "name": "Merchant ID",
                   "len": 16,
                   "data": "BREBCO9001234560", // Dato correspondiente al valor de llave
                   "rawData": "BREBCO9001234560"
               }
           },
   ```
...
6. **Iniciar la transacción:** Con los datos obtenidos de la resolución de la llave (signer handle), Transaction Amount y el IdQR. La Entidad Participante está lista para iniciar la transacción, para esto deberá invocar el servicio expuesto por Transfiya. Se relaciona una tabla con la homologación de los campos y un ejemplo que sirve como guia.
   ...
   | received          | N/A               | Marca de tiempo                                                                                                                                                                                                                                               |
   | dispatched        | N/A               | Marca de tiempo                                                                                                                                                                                                                                               |
   | deviceFingerPrint | N/A               | Objeto con la información del dispositivo que genera la tx                                                                                                                                                                                                    |
