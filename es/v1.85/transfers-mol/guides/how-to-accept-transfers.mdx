...
<Steps>
  ...
  <Step title='Banco Destino Registra el "signer" en Transfiya'>
    ...
    ```json Request Account Signer expandable
    curl -X POST \
        -H "x-api-key: <API_KEY>" \
        -H "Authorization: Bearer <TOKEN>" \
        -H "Content-Type: application/json" \
    ...
    ```json Response Account Signer expandable
    curl -X POST \
    -H "x-api-key: <API_KEY>" \
    -H "Authorization: Bearer <TOKEN>" \
    -H "Content-Type: application/json" \
    ...
    ```json Request Alias Signer expandable
    curl -X POST \
       -H "x-api-key: <API_KEY>" \
       -H "Authorization: Bearer <TOKEN>" \
       -H "Content-Type: application/json" \
    ...
    ```json Response Alias Signer expandable
    curl -X POST \
    -H "x-api-key: <API_KEY>" \
    -H "Authorization: Bearer <TOKEN>" \
    -H "Content-Type: application/json" \
    ...
    ```json Error Response expandable
    curl -X POST \
    -H "x-api-key: <API_KEY>" \
    -H "Authorization: Bearer <TOKEN>" \
    -H "Content-Type: application/json" \
