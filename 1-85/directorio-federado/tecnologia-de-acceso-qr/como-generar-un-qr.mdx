...
| vat                    | decimal    | Valor del IVA con dos decimales<br />Este campo es obligatorio, si el campo personType = "LEGAL"                                                               | Min 1 - Máx 13                       | NO              |
| vatBase                | decimal    | Base del IVA con dos decimales<br />Este campo es obligatorio, si el campo personType = "LEGAL"                                                                | Min 1 - Máx 13                       | NO              |
| tax                    | decimal    | Valor del impuesto INC con dos decimales<br />Este campo es obligatorio, si el campo personType = "LEGAL"                                                      | Min 1 - Máx 13                       | NO              |
