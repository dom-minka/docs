...
Las llaves a nivel de regulación se mapearán a los credenciales de pago [signers](../about/about-signers) de Transfiya en una relación uno a uno.

<Info>
    Las billeteras permitían asignar múltiples cuentas a una sola llave. Esta funcionalidad está disponible por motivos de compatibilidad, pero no se utilizará en las llaves Bre-B.
</Info>
