---
title: "Flujos regulados y no regulados"
sidebarTitle: "Flujos regulados por BreB"
description: "Resumen sobre el flujo de transferencias regulados y no regulados"
---

# Sobre flujos

## Que cambios son necesarios en nivel de integracion de participante.

Para los participantes de Transifya no es necesario realizar *ningun cambio* en su sistema de integracion actual.

<Note>
    Los participantes de Transfiya tienen que asegurar buenos tiempos de respuesta en sus sistemas de integracion actual y elimiar cualquier tipo de validacion adicionales internas.
</Note>
