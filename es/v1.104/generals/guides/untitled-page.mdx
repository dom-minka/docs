...
** **El sistema a de la entidad deberá realizar el firmado de las acciones (Upload, Download, SEND, SENDMOL, Withdraw y Claim) generando un hash y enviandolo al siguiente endpoint de Tranfiya **POST /v1/action/:action\_id/sendit**
...
- **Convertir data a JSON canónico**\
  Serializa data a JSON **determinístico**:
