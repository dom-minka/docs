...
| businnesName           | string     | Nombre del comercio o razón social cuando es persona jurídica                                                                                                  | Min 1 - Máx 25                       | NO              |
| **location**           | **object** |                                                                                                                                                                |                                      | **SI**          |
...
| categoryCode           | string     | Categoría del comercio destino<br />Si el campo personType = "LEGAL", el valor de este campo debe ser diferente de 0000 y va de acuerdo al estándar ISO 18245. | Min 1 - Máx 4                        | SI              |
| terminal               | string     | Terminal asociada al comercio destino                                                                                                                          | Min 1 - Máx 25                       | SI              |
| vat                    | decimal    | Valor del IVA con dos decimales<br />Este campo es obligatorio, si el campo personType = "LEGAL"                                                               | Min 1 - Máx 13                       | COND            |
| vatBase                | decimal    | Base del IVA con dos decimales<br />Este campo es obligatorio, si el campo personType = "LEGAL"                                                                | Min 1 - Máx 13                       | COND            |
| tax                    | decimal    | Valor del impuesto INC con dos decimales<br />Este campo es obligatorio, si el campo personType = "LEGAL"                                                      | Min 1 - Máx 13                       | COND            |
