...
description: "Descripción detallada sobre el modelo de datos en Transfiya"
icon: "table"
---
...
Con el objetivo de asegurar la correcta construcción de la llave tipo _merchant_, se establece el siguiente ajuste en la lógica de lectura:
...
- Tomar los siguientes **10 caracteres**, los cuales conformarán la estructura de la llave tipo _merchant_.

**Ejemplo:**

TAG: "50"<br />len: 31<br />data: "[011000911500130013CO.COM.RBM.CU](http://011000911500130013CO.COM.RBM.CU)"
...
- Los siguientes **8 caracteres** completarán la estructura de la llave tipo _merchant_.
