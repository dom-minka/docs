...
<Info>
  Transfiya **no implementa actualmente** un protocolo de confirmación en dos fases (_two-phase commit_), aunque este podría incorporarse utilizando la llamada de `status` como segunda fase del proceso.
</Info>
