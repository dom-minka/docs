...
<Info>
Los <strong>timestamps finales</strong> son reportados por los bancos origen y destino en los pasos <strong>50</strong> y <strong>55</strong>.
</Info>

### Ejemplo de API

**POST /v1/transfer/:handle/timestamps**
