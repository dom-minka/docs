...
| --- | --- | --- | --- | --- | --- |
| source | string | Handle del signer origen <br />ó estructura del cuenta a cuenta si se usará <br />GENERIC signer como origen | Min 1 - <br />Max 50 | SI<br /> | N/A |
| target | string | Datos del receptor | Min 1 - Max 80 | SI | La estructura debe ser:<br />tipo de cuenta:número de cuenta@código compensación del banco receptor<br />Ej: svgs:88745145@1007<br />Los valores : y @ son fijos |
...
| identification | string | Número de identificación del originador | Min 1 Max 34 | SI | Cuando el tipo de documento es NIT, el valor es sin<br />digito de verificación y sin guion. |
...
| identification | string | Número de identificación del beneficiario | Min 1 Max 34 | SI | Cuando el tipo de documento es NIT, el valor es sin<br />digito de verificación y sin guion. |
