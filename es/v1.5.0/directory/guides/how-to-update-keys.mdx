...
Para actualizar las llaves usamos el modelo de actualizacion de objeto signer [../about/aobut-signers].
...
Para obtener más información sobre cómo sincronizar con DICE, consulte [how-to-sync-dice].
